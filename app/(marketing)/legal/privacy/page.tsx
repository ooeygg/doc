...
export const metadata: Metadata = {
  ...createPageMetadata({
    ...
    description:
      "Privacy policy for Work of Angels, LLC. We collect only what is necessary to respond to inquiries and run the practice.",
    path: "/legal/privacy",
  }),
  ...
  return (
    <Container width="prose" className="py-24">
      ...
      <div className="font-body mt-8 space-y-6 text-base leading-relaxed opacity-80">
        <p>
          This site collects only the information necessary to respond to your inquiries and run the practice. We do not
        ...
        <p>For questions about how your information is handled, please reach out via the contact page.</p>
