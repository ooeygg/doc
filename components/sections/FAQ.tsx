        ...
        <div className="border-divider divide-divider divide-y border-y">
          {faq.map((entry) => (
            <details key={entry.question} name="homepage-faq" className="group py-2">
              <summary className="focus-visible:ring-gold flex cursor-pointer list-none items-center justify-between gap-4 py-4 text-left focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none [&::-webkit-details-marker]:hidden">
